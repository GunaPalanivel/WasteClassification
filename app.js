...
async function predict() {
  ...
  console.log(
    "RESULT = " + highestConfidence.label + ": " + highestConfidence.confidence
  );
  ...
  highestConfidence.innerHTML =
    "This item is a " + itemNameMap.get(highestConfidence.label) + ".";
  ...
  sortCategory.innerHTML =
    "It should go in the " + itemCategoryMap.get(highestConfidence.label) + ".";
  ...
  return console.log("its cooking");
}
